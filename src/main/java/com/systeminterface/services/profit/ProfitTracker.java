...
public final class ProfitTracker
{
	...
	@Inject
	public ProfitTracker(ItemManager itemManager, StateTracker stateTracker)
	{
		this(stateTracker, itemManager::getItemPrice);
	}
	...
	/** Per-unit value: coins/platinum tokens at face value, everything else at GE price. */
