...
public final class WikiDropTableParser
{
	...
	static DropTable parseDropsFromWikitext(String targetName, String wikitext)
	{
		...
		return table.drops.isEmpty() && !hasInfoboxData(table) ? null : table;
	}

	private static boolean hasInfoboxData(DropTable table)
	{
		return table != null
			&& (table.examine != null
				|| table.combatLevel > 0
				|| table.maxHp > 0
				|| table.maxHit != null
				|| table.attackStyle != null
				|| table.weakness != null
				|| table.imageFile != null
				|| table.slayerLevel > 0
				|| table.members != null);
	}
