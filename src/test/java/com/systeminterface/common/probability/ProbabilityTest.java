...
public class ProbabilityTest
{
	...
	@Test
	public void petChance_redwoodOverride_level99()
	{
		// Redwood uses 223017 base: 1 / (223017 - 99*25) = 1 / 220542
		double chance = Probability.petChance(223017, 99);
		assertEquals(1.0 / 220542.0, chance, EPS);
	}
